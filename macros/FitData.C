...
void rData(const char *subdetect){
  ...
  //std::string dirFile ="/eos/cms/store/group/dpg_rpc/comm_rpc/Run-II/data2017/HVscan_Offline/HVScan_2017September_selPt7_chi8";
   std::string dirFile = "/eos/cms/store/group/dpg_rpc/comm_rpc/Run-III/HVmini_scan/";
   for (std::vector<int>::const_iterator Sample = samples.begin(); Sample != samples.end(); Sample++) {	
		...
		if (*Sample == -1) ch->Add((dirFile+"/AnaEfficiency_HVmini_P86_RPCMon2022.root/effTreeEndcap").c_str());
 		if (*Sample == -2) ch->Add((dirFile+"/AnaEfficiency_HVmini_P88_RPCMon2022.root/effTreeEndcap").c_str());
  		if (*Sample == -3) ch->Add((dirFile+"/AnaEfficiency_HVmini_P90_RPCMon2022.root/effTreeEndcap").c_str());
  		if (*Sample == -4) ch->Add((dirFile+"/AnaEfficiency_HVmini_P91_RPCMon2022.root/effTreeEndcap").c_str());
  		if (*Sample == -5) ch->Add((dirFile+"/AnaEfficiency_HVmini_P92_RPCMon2022.root/effTreeEndcap").c_str());
  		if (*Sample == -6) ch->Add((dirFile+"/AnaEfficiency_HVmini_P93_RPCMon2022.root/effTreeEndcap").c_str());
  		if (*Sample == -7) ch->Add((dirFile+"/AnaEfficiency_HVmini_P94_RPCMon2022.root/effTreeEndcap").c_str());
  		if (*Sample == -8) ch->Add((dirFile+"/AnaEfficiency_HVmini_P95_RPCMon2022.root/effTreeEndcap").c_str());
  		if (*Sample == -9) ch->Add((dirFile+"/AnaEfficiency_HVmini_P96_RPCMon2022.root/effTreeEndcap").c_str());
  		if (*Sample == -10) ch->Add((dirFile+"/AnaEfficiency_HVmini_P97_RPCMon2022.root/effTreeEndcap").c_str());
  		if (*Sample == -11) ch->Add((dirFile+"/AnaEfficiency_HVmini_P98_RPCMon2022.root/effTreeEndcap").c_str());
		if (*Sample == 1) ch->Add((dirFile+"/AnaEfficiency_HVmini_P86_RPCMon2022.root/effTreeBarrel").c_str());
 		if (*Sample == 2) ch->Add((dirFile+"/AnaEfficiency_HVmini_P88_RPCMon2022.root/effTreeBarrel").c_str());
  		if (*Sample == 3) ch->Add((dirFile+"/AnaEfficiency_HVmini_P90_RPCMon2022.root/effTreeBarrel").c_str());
  		if (*Sample == 4) ch->Add((dirFile+"/AnaEfficiency_HVmini_P91_RPCMon2022.root/effTreeBarrel").c_str());
  		if (*Sample == 5) ch->Add((dirFile+"/AnaEfficiency_HVmini_P92_RPCMon2022.root/effTreeBarrel").c_str());
  		if (*Sample == 6) ch->Add((dirFile+"/AnaEfficiency_HVmini_P93_RPCMon2022.root/effTreeBarrel").c_str());
  		if (*Sample == 7) ch->Add((dirFile+"/AnaEfficiency_HVmini_P94_RPCMon2022.root/effTreeBarrel").c_str());
  		if (*Sample == 8) ch->Add((dirFile+"/AnaEfficiency_HVmini_P95_RPCMon2022.root/effTreeBarrel").c_str());
  		if (*Sample == 9) ch->Add((dirFile+"/AnaEfficiency_HVmini_P96_RPCMon2022.root/effTreeBarrel").c_str());
  		if (*Sample == 10) ch->Add((dirFile+"/AnaEfficiency_HVmini_P97_RPCMon2022.root/effTreeBarrel").c_str());
  		if (*Sample == 11) ch->Add((dirFile+"/AnaEfficiency_HVmini_P98_RPCMon2022.root/effTreeBarrel").c_str());
   		TTree *t = (TTree*)ch;
